...
- [ ] Add automated UI coverage for grid snapping, orthogonal edge control dragging, and marquee multi-node selection or movement workflows.
...
- [ ] Decide whether future canvas routing should stay purely manual or gain obstacle-avoidance, route-cleanup assistance, or reset-to-auto behavior on top of the new single-anchor control-point editor.
