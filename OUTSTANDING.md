...
- [ ] Extend operator-facing `Fed From` coverage beyond the current breaker / wire / PTX / ATS / UPS lineup, which now includes handle-aware switchboard precedence and the `ExampleTopology/NTT-CH3-TOPOLOGY.json` regression fixture.
