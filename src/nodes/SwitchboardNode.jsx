...
function BusIcon({ className }) {
  return (
    <svg
      ...
      strokeWidth="1.7"
    >
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 6.5h16M4 17.5h16" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 6.5v11m4-11v11m4-11v11" />
    </svg>
  );
}
    ...
    >
      <div className="flex items-center justify-between gap-2">
        <div className="inline-flex items-center gap-2">
          <BusIcon className={`h-4 w-4 ${titleClassName}`} />
      ...
      <div className="mt-2 text-xs text-slate-300">{data.boardClass ?? "MDB / UPS Board"}</div>
...
export default SwitchboardNode;
